...
if __name__ == "__main__":
    ...
    if greedy_version == 1:
        ...
        file_name = f"SmartGrid/data/solutions/10k_it_or_greedy_ctc_dis{district_number}.pickle"

        with open(file_name, 'wb') as handle:
            pickle.dump(best_greedy, handle)

        file_name = f"SmartGrid/data/solutions/10k_it_or_greedy_ctc_dis{district_number}_cost_list.pickle"
    ...
    if greedy_version == 2:
        ...
        # file_name = f"SmartGrid/data/solutions/best_greedy2.pickle"
    ...
    file_name = f"SmartGrid/data/solutions/10k_it_or_greedy_ctc_dis1_1mil_it_simanneal_{simanneal_id}_ctc.pickle"
    ...
    experiments["start_grid"] = "10k_original_greedy_ctc"
    ...
    # climber = hill_climber.Hill_climber(simanneal.grid, fix = True, mutate_house_number=10)
